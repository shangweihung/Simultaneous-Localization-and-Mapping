...
if __name__ == '__main__':
    ...
    now_list,grid = slam(X,W,encoder_stamps,encoder_pos,lidar_stamsp,lidar_ranges,grid,res,SLAM_MAP,WALK_MAP,Texture_map)
